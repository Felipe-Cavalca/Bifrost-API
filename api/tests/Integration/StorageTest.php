...
final class StorageTest extends TestCase
{
    ...
    public function testLocalStorageWritesReadsAndDeletesFiles(): void
    {
        ...
        $key = new StorageKey(key: 'reports/example.txt');

        $putResult = $storage->put(key: $key, body: 'content');
        $getResult = $storage->get(key: $key);
        $deleteResult = $storage->delete(key: $key);
    ...
    public function testLocalStorageRejectsPathTraversal(): void
    {
        ...
        new StorageKey(key: '../outside.txt');
    }
    ...
    public function testStorageFactoryUsesConfiguredLocalVolumePath(): void
    {
        ...
        $storage->put(key: new StorageKey(key: 'volume/file.txt'), body: 'volume');
